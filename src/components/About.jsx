  ...
  return (
    <section className="about" id="about">
      ...
      <div className="about-content">
        ...
        <p>Olá! Meu nome é Miguel e sou um desenvolvedor web full stack com paixão por tecnologia e inovação. Com 30 anos de idade, tenho experiência em algumas linguagens e ferramentas de programação, incluindo JavaScript, HTML, CSS, React, Jest, RTL, Docker, SQL, Node.js.
